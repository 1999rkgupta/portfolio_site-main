...
const HeaderIntro: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <img
        src={"https://cdn.pixabay.com/photo/2021/10/10/18/20/super-6698001_640.png"}
        alt={"https://cdn.pixabay.com/photo/2021/10/10/18/20/super-6698001_640.png"}
      ...
      <div className="button-container flex items-center justify-center mr-8 gap-10 mb-12 max-lg:flex-col max-lg:items-center">
        {headerIntroData.buttons.map((button, index) => (
          <Button
            key={index}
            label={language === "EN" ? button.label.en : button.label.en}
            iconSVG={button.icon}
